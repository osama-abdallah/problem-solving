...
const customerAndAge = (obj) => {
 ...
 finalArr.push(`Customer Name :${newArr[i][0]} , Age :${newArr[i][1]}`)
...
if (courses[i].Students.includes(item)){
  course=courses[i].course 
}
  }
    newArr.push({Student:item , course: course})
  })
  return newArr
};
